...
// const Remark = (await import('https://esm.sh/remark@14.0.2')).remark;
const { remark } = await import('https://cdn.skypack.dev/remark@14?min');

// const RemarkGfm = (await import('https://esm.sh/remark-gfm@3.0.1'));
// const  remarkGfm = (await import ('https://cdn.skypack.dev/remark-gfm@3?min')).default;
// const remarkToc = (await import('https://cdn.skypack.dev/remark-toc@8?min')).default;
// const remarkRehype = (await import('https://cdn.skypack.dev/remark-rehype@10?min')).default;
// const rehypeStringify = (await import('https://cdn.skypack.dev/rehype-stringify@9?min')).default;



const moduleData = [
  { name: 'remarkGfm', url: "https://cdn.skypack.dev/remark-gfm@3?min", f: m => m.default },
  { name: 'remarkToc', url: "https://cdn.skypack.dev/remark-toc@8?min", f: m => m.default },
  { name: 'remarkRehype', url: "https://cdn.skypack.dev/remark-rehype@10?min", f: m => m.default },
  { name: 'rehypeStringify', url: "https://cdn.skypack.dev/rehype-stringify@9?min", f: m => m.default },
  // { name: 'FrontMatter', url: "https://esm.sh/remark-frontmatter@4.0.1", f: m => m.default },
...
export const mdParser = await remark()
